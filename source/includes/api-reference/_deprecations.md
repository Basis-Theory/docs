...
|---------------------------------------------------|------------------|------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Token Privacy Settings                            | October 13, 2022 | February 1, 2023 | Privacy settings (i.e. [classification](#tokens-token-classifications), [impact level](#tokens-token-impact-levels), and [restriction policy](#tokens-token-restriction-policies)) have been deprecated and replaced by a more flexible authorization model based upon [Containers](https://developers.basistheory.com/concepts/what-are-token-containers) and [Access Rules](https://developers.basistheory.com/concepts/access-controls/#what-are-access-rules). For more information, see the section below on [Migrating from Privacy Settings](/#deprecations-migrating-from-privacy-settings). |
