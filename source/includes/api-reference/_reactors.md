...
`created_by` | *uuid* | The [application](#applications) ID which created the Reactor
`created_at` | *string* | Created date of the Reactor in ISO 8601 format
`modified_by` | *uuid* | The [Application](#applications) ID which last modified the Reactor
