...
| `application`   | *[Application](#applications-application-object)*             |     | An optional Application used for injecting a pre-configured Basis Theory instance in the Reactor runtime                                    |
